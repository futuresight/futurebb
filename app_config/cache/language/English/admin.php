...
$lang_addl = array (
  ...
  'jk' => 'Just kidding',
  'censorintro' => 'You may use this page to set inappropriate words to censor.<br />This will not affect old posts unless the reparse posts function is used (available on the <a href="$baseurl$/admin/maintenance">maintenance page</a>).',
