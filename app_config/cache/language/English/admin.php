...
$lang_addl = array (
  ...
  'jk' => 'Just kidding',
  'censorintro' => 'You may use this page to set inappropriate words to censor.<br />This will not affect old posts unless the reparse posts function is used (available on the <a href="https://testserver.int/futurebb/admin/maintenance">maintenance page</a>).',
  ...
  'modprivsdesc' => 'This option gives users access to the moderator tools. You may choose which specific tools to allow with the options below.',
  ...
  'maxnumlines' => 'Maximum number of lines',
