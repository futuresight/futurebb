...
<div class="container">
	...
	function prepareDeleteCat(cat_id) {
		...
		if (document.getElementById('delete_cat_' + cat_id)) {
			...
			document.getElementById('submitBox').appendChild(newHiddenInput);
			tr.getElementsByTagName('a')[3].innerHTML = 'Cancel';
			unlockSubmit();
		}
	}
