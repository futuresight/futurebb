	...
	if ($edit) {
		switch ($dirs[3]) {
			case '':
				...
				<?php
				echo '<p><a href="' . $base_config['baseurl'] . '/search?query=&author=' . rawurlencode(htmlspecialchars($cur_user['username'])) . '&forum=0&sortby=posttime&direction=desc">' . translate('showallposts') . '</a></p>';
				?>
